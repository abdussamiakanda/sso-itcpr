...
async function checkPopupMode() {
    ...
    if (isPopup && parentUrlParam && (url.hostname.endsWith('.itcpr.org') || url.hostname === 'itcpr.org' || url.origin === 'http://127.0.0.1:5500' || url.origin === 'http://localhost:5173' || url.origin === 'http://localhost:3000')) {
        isPopupMode = true;
